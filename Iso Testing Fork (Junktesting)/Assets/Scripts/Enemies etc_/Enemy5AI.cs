...
public class Enemy5AI : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        ScoreManager.totalScore = System.Convert.ToInt32(ScoreManager.totalScore + (25 * (1 + ComboManager.bonusFactor)));
    }
    ...
    void Start()
    {
        ...
        IEnumerator enemyAI()
        {
            while (moveOn == true)
            {
                ...
                AudioSource.PlayClipAtPoint(shotSFX, transform.position, .2f);
